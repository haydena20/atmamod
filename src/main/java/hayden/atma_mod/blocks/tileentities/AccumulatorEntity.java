...
//		else 
//		{
//			ItemStack result = AtmaFurnaceRecipes.getInstance().getAtmaResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
...
//		ItemStack result = AtmaFurnaceRecipes.getInstance().getAtmaResult(input1,input2);
//		ItemStack output = (ItemStack)this.inventory.get(3);
//		
//		if(output.isEmpty())
...
//			
//			if(item == ModItems.ATMACRYSTAL) return 1000;
//			if(item == ModItems.LESSERATMACRYSTAL) return 100;
//
...
//				{
//					flag1 = true;
//					SolarAccumulator.setState(this.isBurning(), this.world, this.pos);
//				}
